...
import { getAllActivities, uploadVideoForActivity } from "../Controller/Activity.controller.js"
...
router.post('/activity/:activityNumber', upload.single('video'), uploadVideoForActivity);
